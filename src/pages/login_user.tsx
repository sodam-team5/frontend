    ...
    <div>
      ...
      <div className="flex flex-col items-center gap-4 p-6">
        ...
        <div className="flex flex-col">
          <h3 className="flex items-left pt-[45px] font-bold">어르신 성함을 입력해주세요</h3>
        ...
        <div className="flex flex-col items-left">
          <h3 className="flex items-left pt-[15px] font-bold">말벗 성함을 입력해주세요</h3>
        ...
        <button className="bg-gray-300 w-[220px] h-[38px] rounded-[10px] font-bold"
